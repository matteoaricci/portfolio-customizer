...
export default function FilmCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setCoverImagePath(initialValues.coverImagePath);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Film(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "FilmCreateForm")}
      {...rest}
    >
      <TextField
        label="Title"
