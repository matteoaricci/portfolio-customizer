...
export default function BehindSceneShotCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new BehindSceneShot(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "BehindSceneShotCreateForm")}
      {...rest}
    >
      <TextField
        label="Image path"
